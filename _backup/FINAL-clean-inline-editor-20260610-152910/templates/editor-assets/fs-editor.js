(function(){
  ...
  ready(function(){
    ...
    function applyTheme(theme){
      ...
      if(logo){
        const nextLogo = mode === "dark" ? logo.dataset.dark : logo.dataset.light;
    ...
    function renderPanel(){
      ...
      if(isQr){
        ...
        $("fsxQrBg").addEventListener("input", () => setQrBg($("fsxQrBg").value));
      } else {
        body.innerHTML = `
          <div class="fsx-card">
        ...
        $("fsxWeight").addEventListener("change", () => setTextWeight($("fsxWeight").value));
    ...
    function setTextFont(v){ if(selected.id !== "qrBox") selected.style.fontFamily = v; }
    function setTextWeight(v){
      if(selected.id !== "qrBox"){
        selected.style.fontWeight = v;
        if($("fsxWeight")) $("fsxWeight").value = v;
        if($("fsxTopWeight")) $("fsxTopWeight").value = v;
      }
    }
