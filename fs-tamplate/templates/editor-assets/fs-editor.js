(function(){
  ...
  ready(function(){
    ...
    function applyTheme(theme){
      ...
      const topTheme = document.getElementById("fsxTopTheme");
      if(topTheme) topTheme.textContent = icon;

      const floatTheme = document.getElementById("fsxFloatingTheme");
      if(floatTheme) floatTheme.textContent = icon;
    ...
    function ensureFloatingTheme(){
      let btn = document.getElementById("fsxFloatingTheme");
      if(!btn){
        btn = document.createElement("button");
        btn.type = "button";
        btn.id = "fsxFloatingTheme";
        btn.className = "fsx-floating-theme";
    ...
    function renderToolbar(){
      ...
      const fsxTopThemeBtn = $("fsxTopTheme"); if(fsxTopThemeBtn) fsxTopThemeBtn.addEventListener("click", toggleTheme);
